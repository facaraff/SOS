...
public class RandUtilsBACKUP
{
	...
	{
		return (int) Math.round((n)*RandUtilsBACKUP.random());
	}
	...
	public static int randomIntegerExcl(int a, int b, int excl)
	{
		...
		do
		{
			r = a+RandUtilsBACKUP.randomInteger(b-a);
		}
		while (r == excl);
		return r;
	}
	...
	public static int randomIntegerExcl(int n, int excl)
	{
		...
		do
		{
			r = RandUtilsBACKUP.randomInteger(n);
		}
		while (r == excl);
		return r;
	}
	...
	public static int[] randomPermutation(int[] a)
	{
		...
		for (int k = n-1; k > 0; k--)
		{
			int w = (int) Math.floor(RandUtilsBACKUP.random()*(k+1));
			int temp = b[w];
			b[w] = b[k];
			b[k] = temp;
		}
	...
	{
		return locationFactor + scaleFactor*Math.tan(Math.PI*(RandUtilsBACKUP.random() - 0.5));
	}
	...
	{
		return a + (b-a)*RandUtilsBACKUP.random();
	}
	...
	public static int randomIntegerExcl(int a, int b, int excl, Counter counter)
	{
		...
		do
		{
			r = a+RandUtilsBACKUP.randomInteger(b-a, counter);
		}
		while (r == excl);
		return r;
	}
	...
	public static int randomIntegerExcl(int n, int excl, Counter counter)
	{
		...
		do
		{
			r = RandUtilsBACKUP.randomInteger(n, counter);
		}
		while (r == excl);
		return r;
	}
	...
	public static int[] randomPermutation(int[] a, Counter counter)
	{
		...
		for (int k = n-1; k > 0; k--)
		{
			int w = (int) Math.floor(RandUtilsBACKUP.random(counter)*(k+1));
			int temp = b[w];
			b[w] = b[k];
			b[k] = temp;
		}
