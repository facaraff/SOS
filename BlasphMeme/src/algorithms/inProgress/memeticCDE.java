 ...
 */
public class memeticCDE extends Algorithm
{
...
//			mutationStrategy = RandUtils.randomInteger(4)+1;
//			
//			// mutation
...
//
//			
//			crossoverStrategy = RandUtils.randomInteger(3)+1;
//			
//			// crossover
...
//			
			...
			//else
			//{
//				b = generateIndividual(mean, sigma2);for (int n = 0; n < problemDimension; n++)
//					sigma2_F[n] = Fmod*sigma2[n];
//				b = generateIndividual(mean, sigma2_F);
//				b = crossOverBin(best, b, CR);
////				xr = generateIndividual(mean, sigma2);
