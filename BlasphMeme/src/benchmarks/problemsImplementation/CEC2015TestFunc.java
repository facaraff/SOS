...
import static benchmarks.problemsImplementation.CEC2015_extra.MMatrix10.getM10;
import static benchmarks.problemsImplementation.CEC2015_extra.MMatrix30.getM30;
//import static benchmarks.helpers.CEC2015M.MMatrix100.getM100; too large!!
...
{ 
	...
	*/
	...
	public double[] getM() throws Exception
	{
		...
		{	
			Scanner input = new Scanner(this.getClass().getResourceAsStream("CEC2015_extra"+slash+"files_cec2015"+slash+"M_"+func_num+"_D"+nx+".txt"));
