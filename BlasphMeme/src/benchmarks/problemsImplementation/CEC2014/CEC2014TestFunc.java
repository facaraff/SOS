...
public class CEC2014TestFunc {
	...
	public CEC2014TestFunc(int nx, int func_num)throws Exception
	{
	...
	{		
		...
		case 5:
			...
			break;
		case 6:
			f=weierstrass_func(x,1,1);
			f+=600.0;
			break;
		case 7:	
			f=griewank_func(x,1,1);
			f+=700.0;
			break;
		case 8:	
		...
		case 10:	
			...
			break;
		case 11:	
			f=schwefel_func(x,1,1);
			f+=1100.0;
			break;
		case 12:	
			f=katsuura_func(x,1,1);
			f+=1200.0;
			break;
		case 13:	
			f=happycat_func(x,1,1);
			f+=1300.0;
			break;
		case 14:	
			f=hgbat_func(x,1,1);
			...
			break;
		case 15:	
			f=grie_rosen_func(x,1,1);
			f+=1500.0;
			break;
		case 16:	
			f=escaffer6_func(x,1,1);
			f+=1600.0;
			break;
		case 17:
			f=hf01(x,1,1);
